...
from keras.models import load_model  # Add this import to load the 3D CNN model
...
i3d_model = load_model("path_to_your_trained_3d_cnn_model.hd5")  # Replace with the path to your trained 3D CNN model
    ...
    if filename.endswith(".mp4"):
        ...
        while True:
            ...
            if bounding_boxes:
                ...
                # Perform action recognition inference using the 3D CNN model
