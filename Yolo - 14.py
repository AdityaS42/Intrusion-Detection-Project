...
# Define the action class names
action_class_names = ["climb", "jump", "run", "sit", "stand", "turn", "walk"]  # Replace with actual action names
                ...
                for detection in out:
                    ...
                    if confidence > 0.5 and classes[class_id] == "person":
                        ...
                        if len(frame_buffer) == frame_buffer_size:
                            ...
                            # Get the action name from the defined class names
                            action_name = action_class_names[action_class]

                            # Draw bounding box and label with action name
